...
-- Dumping data for table mm.caixa: ~1 rows (approximately)
/*!40000 ALTER TABLE `caixa` DISABLE KEYS */;
INSERT INTO `caixa` (`id`, `valor_inicial`, `valor_fechamento`, `funcionario_id`, `dt_abertura`, `dt_fechamento`) VALUES
	(21, 50.00, 0.00, 1, '2017-10-25 17:37:33', NULL),
	(22, 50.00, 0.00, 1, '2017-10-25 17:37:41', NULL);
...
-- Dumping data for table mm.itens_venda: ~2 rows (approximately)
...
-- Dumping data for table mm.pessoa: ~41 rows (approximately)
...
INSERT INTO `produto` (`id`, `codigo`, `codbar`, `categoria_id`, `nome`, `descricao`, `valor`, `unidade_id`, `estoque_min`, `estoque`, `tem_estoque`, `active`) VALUES
	(2, '001', NULL, 2, 'Teste', NULL, 10.00, 1, 5, 13, 'y', 'y');
...
-- Dumping data for table mm.venda: ~2 rows (approximately)
...
-- Dumping data for table mm.venda_pagto: ~3 rows (approximately)
