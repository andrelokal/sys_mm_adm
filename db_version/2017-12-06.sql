...
-- Copiando dados para a tabela mm_bd.acesso: ~0 rows (aproximadamente)
...
-- Copiando dados para a tabela mm_bd.caixa: ~3 rows (aproximadamente)
...
-- Copiando dados para a tabela mm_bd.categoria: ~4 rows (aproximadamente)
...
-- Copiando dados para a tabela mm_bd.comanda_mesa: ~4 rows (aproximadamente)
...
INSERT INTO `comanda_mesa` (`id`, `codigo`, `active`, `status`, `dt_status_O`, `dt_status_L`, `venda_id`) VALUES
	(3, '01', 'y', 'L', '2017-12-01 19:44:57', NULL, NULL),
	(4, '02', 'y', 'L', '2017-11-29 07:56:57', NULL, NULL),
...
-- Copiando estrutura para tabela mm_bd.delivery
...
-- Copiando dados para a tabela mm_bd.delivery: ~2 rows (aproximadamente)
...
-- Copiando dados para a tabela mm_bd.entrada_produto: ~0 rows (aproximadamente)
...
-- Copiando dados para a tabela mm_bd.fisica: ~6 rows (aproximadamente)
...
-- Copiando dados para a tabela mm_bd.fisica_conta: ~1 rows (aproximadamente)
...
-- Copiando dados para a tabela mm_bd.funcionario: ~0 rows (aproximadamente)
...
-- Copiando dados para a tabela mm_bd.help: ~2 rows (aproximadamente)
...
-- Copiando dados para a tabela mm_bd.help_item: ~6 rows (aproximadamente)
...
-- Copiando dados para a tabela mm_bd.itens_venda: ~24 rows (aproximadamente)
...
-- Copiando dados para a tabela mm_bd.log: ~0 rows (aproximadamente)
/*!40000 ALTER TABLE `log` DISABLE KEYS */;
/*!40000 ALTER TABLE `log` ENABLE KEYS */;

-- Copiando estrutura para tabela mm_bd.module
...
-- Copiando dados para a tabela mm_bd.module: ~16 rows (aproximadamente)
...
-- Copiando dados para a tabela mm_bd.modulo: ~4 rows (aproximadamente)
...
-- Copiando dados para a tabela mm_bd.pessoa: ~57 rows (aproximadamente)
...
-- Copiando dados para a tabela mm_bd.produto: ~65 rows (aproximadamente)
/*!40000 ALTER TABLE `produto` DISABLE KEYS */;
INSERT INTO `produto` (`id`, `codigo`, `codbar`, `categoria_id`, `nome`, `descricao`, `valor`, `unidade_id`, `estoque_min`, `estoque`, `tem_estoque`, `status_inicial`, `active`) VALUES
	(1, 'PX', NULL, 4, 'PIZZA MISTA', NULL, 0.00, 2, 0, -3, 'y', 'A', 'n'),
	(69, 'P01', NULL, 4, 'MUSSARELA', 'mussarela, tomate e azeitonas', 34.70, 4, 0, -23, 'n', 'A', 'y'),
	(70, 'P02', NULL, 4, 'CATUPIRI', 'catupiri, tomate e azeitonas', 45.00, 4, 0, -10, 'n', 'A', 'y'),
	(71, 'P03', NULL, 4, 'MARGUERITA', 'mussarela, tomate, manjeric?o, parmes?o e azeitonas', 34.70, 4, 0, -6, 'n', 'A', 'y'),
	(72, 'P04', NULL, 4, 'PROMUSSA', 'provolone, mussarela e azeitonas', 34.70, 4, 0, -3, 'n', 'A', 'y'),
	(73, 'P05', NULL, 4, 'TR?S QUEIJOS', 'mussarela, provolone, catupiri e azeitonas', 34.70, 4, 0, -3, 'n', 'A', 'y'),
	(74, 'P06', NULL, 4, 'QUATRO QUEIJOS', 'mussarela, provolone, catupiri, gorgonzola e azeitonas', 34.70, 4, 0, 0, 'n', 'A', 'y'),
	(75, 'P07', NULL, 4, 'CALABRESA ( calabresa, mussarela, cebola e azeitonas)', NULL, 34.70, 4, 0, 0, 'n', 'A', 'y'),
	(76, 'P08', NULL, 4, 'PRESUNTO (mussarela, tomate, presunto e azeitonas)', NULL, 34.70, 4, 0, -2, 'n', 'A', 'y'),
	(77, 'P09', NULL, 4, 'ALICHE (mussarela, aliche, tomate e azeitonas)', NULL, 34.70, 4, 0, 0, 'n', 'A', 'y'),
	(78, 'P10', NULL, 4, 'ATUM (mussarela, atum, cebola e azeitonas)', NULL, 34.70, 4, 0, 0, 'n', 'A', 'y'),
	(79, 'P11', NULL, 4, 'LOMBO (mussarela, lombo e azeitonas)', NULL, 34.70, 4, 0, 0, 'n', 'A', 'y'),
	(80, 'P12', NULL, 4, 'CATUPIRI ESPECIAL (catupiri, presunto e azeitonas)', NULL, 34.70, 4, 0, 0, 'n', 'A', 'y'),
	(81, 'P13', NULL, 4, 'BACON (mussarela, bacon, tomate e azeitonas)', NULL, 34.70, 4, 0, 0, 'n', 'A', 'y'),
	(82, 'P14', NULL, 4, 'FRANGO (frango, mussarela, cebola e azeitonas)', NULL, 34.70, 4, 0, 0, 'n', 'A', 'y'),
	(83, 'P15', NULL, 4, 'FRANGO COM CATUPIRI (frango, catupiri, cebola e azeitonas)', NULL, 34.70, 4, 0, 0, 'n', 'A', 'y'),
	(84, 'P16', NULL, 4, 'CATUNGA (catupiri, atum, cebola e azeitonas)', NULL, 34.70, 4, 0, 0, 'n', 'A', 'y'),
	(85, 'P17', NULL, 4, 'FIORENTINA (catupiri, lombo e azeitonas)', NULL, 34.70, 4, 0, 0, 'n', 'A', 'y'),
	(86, 'P18', NULL, 4, 'MILIONÁRIA (catupiri, milho, calabresa e azeitonas)', NULL, 34.70, 4, 0, 0, 'n', 'A', 'y'),
	(87, 'P19', NULL, 4, 'MINEIRINHA (catupiri, lombo, tomate, mussarela e azeitonas)', NULL, 34.70, 4, 0, 0, 'n', 'A', 'y'),
	(88, 'P20', NULL, 4, 'PEKA´S (ervilha, cenoura, palmito, ovos, cebola, vagem, mussarela e azeitonas)', NULL, 34.70, 4, 0, 0, 'n', 'A', 'y'),
	(89, 'P21', NULL, 4, 'À MODA DO PIZZAIOLO (calabresa, catupiri, cebola e azeitonas)', NULL, 34.70, 4, 0, 0, 'n', 'A', 'y'),
	(90, 'P22', NULL, 4, 'À BRASILEIRA (mussarela, tomate, ovos, cebola e azeitonas)', NULL, 34.70, 4, 0, 0, 'n', 'A', 'y'),
	(91, 'P23', NULL, 4, 'ESCAROLA (mussarela, escarola, bacon, cebola, tomate e azeitonas)', NULL, 34.70, 4, 0, 0, 'n', 'A', 'y'),
	(92, 'P24', NULL, 4, 'NAPOLITANA (mussarela, tomate, parmesão e azeitonas)', NULL, 34.70, 4, 0, 0, 'n', 'A', 'y'),
	(93, 'P25', NULL, 4, 'DA MAMA (mussarela, milho, brócolis, palmito e azeitonas)', NULL, 34.70, 4, 0, 0, 'n', 'A', 'y'),
	(94, 'P26', NULL, 4, 'PORTUGUESA (mussarela, presunto, ovos, ervilha, cebola e azeitonas)', NULL, 34.70, 4, 0, 0, 'n', 'A', 'y'),
	(95, 'P27', NULL, 4, 'VENEZA (frango, champignon, catupiri, tomate, mussarela e azeitonas)', NULL, 34.70, 4, 0, 0, 'n', 'A', 'y'),
	(96, 'P28', NULL, 4, 'PARAGUAIA (presunto, tomate, ovos, ervilha, calabresa, mussarela, cebola e azeitonas)', NULL, 34.70, 4, 0, 0, 'n', 'A', 'y'),
	(97, 'P29', NULL, 4, 'LISBOA (presunto, calabresa, tomate, cebola, mussarela e azeitonas)', NULL, 34.70, 4, 0, 0, 'n', 'A', 'y'),
	(98, 'P30', NULL, 4, 'BOLIVIANA (lombo, bacon, ovos, tomate, mussarela, cebola e azeitonas)', NULL, 34.70, 4, 0, 0, 'n', 'A', 'y'),
	(99, 'P31', NULL, 4, 'ITALIANA (mussarela, lombo, calabresa, tomate, milho, ovos, cebola e azeitonas)', NULL, 34.70, 4, 0, 0, 'n', 'A', 'y'),
	(100, 'P32', NULL, 4, 'PALMITO (mussarela, palmito e azeitonas)', NULL, 34.70, 4, 0, 0, 'n', 'A', 'y'),
	(101, 'P33', NULL, 4, 'MILHO (mussarela, milho, bacon e azeitonas)', NULL, 34.70, 4, 0, 0, 'n', 'A', 'y'),
	(102, 'P34', NULL, 4, 'CHAMPIGNON (mussarela, champignon, bacon e azeitonas)', NULL, 34.70, 4, 0, 0, 'n', 'A', 'y'),
	(103, 'P35', NULL, 4, 'MARAVILHA (atum, palmito, ervilha, mussarela e azeitonas)', NULL, 34.70, 4, 0, 0, 'n', 'A', 'y'),
	(104, 'P36', NULL, 4, 'TATUAGEM (presunto, palmito, cebola, mussarela, tomate e azeitonas)', NULL, 34.70, 4, 0, 0, 'n', 'A', 'y'),
	(105, 'P37', NULL, 4, 'SALAME (mussarela, salame, tomate e azeitonas)', NULL, 34.70, 4, 0, 0, 'n', 'A', 'y'),
	(106, 'P38', NULL, 4, '2001 (milho, palmito, lombo, mussarela, cebola e azeitonas)', NULL, 34.70, 4, 0, 0, 'n', 'A', 'y'),
	(107, 'P39', NULL, 4, 'BRÓCOLIS (mussarela, brócolis, bacon e azeitonas)', NULL, 34.70, 4, 0, 0, 'n', 'A', 'y'),
	(108, 'P40', NULL, 4, 'MILHO COM CATUPIRI (catupiri, milho, cebola e azeitonas)', NULL, 34.70, 4, 0, 0, 'n', 'A', 'y'),
	(109, 'P41', NULL, 4, 'BOM GOSTO (5 ingredientes à sua escolha)', NULL, 34.70, 4, 0, 0, 'n', 'A', 'y'),
	(110, 'P42', NULL, 4, 'PEPPERONI (mussarela, pepperoni, cebola e azeitonas)', NULL, 34.70, 4, 0, 0, 'n', 'A', 'y'),
	(111, 'P43', NULL, 4, 'ALHO (mussarela, tomate, cebola, alho e azeitonas)', NULL, 34.70, 4, 0, 0, 'n', 'A', 'y'),
	(112, 'P44', NULL, 4, 'CAMARÃO ( mussarela ou catupiri com camarão temperado)', NULL, 34.70, 4, 0, 0, 'n', 'A', 'y'),
	(113, 'P45', NULL, 4, 'BAIANA (mussarela, calabresa moída apimentada, cebola e azeitonas)', NULL, 34.70, 4, 0, 0, 'n', 'A', 'y'),
	(114, 'P46', NULL, 4, 'BERINJELA (mussarela, berinjela, bacon, cebola e azeitonas)', NULL, 34.70, 4, 0, 0, 'n', 'A', 'y'),
	(115, 'P47', NULL, 4, 'RÚCULA (mussarela de búfala, tomate seco, rúcula e azeitonas)', NULL, 34.70, 4, 0, 0, 'n', 'A', 'y'),
	(116, 'P48', NULL, 4, 'RAMONES (calabresa, gorgonzola, vinagrete e azeitonas)', NULL, 34.70, 4, 0, 0, 'n', 'A', 'y'),
	(117, 'P49', NULL, 4, 'KADÚ (mussarela, catupiri, batata palha e azeitonas)', NULL, 34.70, 4, 0, 0, 'n', 'A', 'y'),
	(118, 'P50', NULL, 4, 'À MODA DA CASA (catupiri, lombo, palmito, champignon, cebola e azeitonas)', NULL, 34.70, 4, 0, 0, 'n', 'A', 'y'),
	(119, 'P51', NULL, 4, 'PIZZA RUTE (mussarela, champignon, pimentão, tomate, cebola e azeitonas)', NULL, 34.70, 4, 0, 0, 'n', 'A', 'y'),
	(120, 'P52', NULL, 4, 'CAIPIRA (frango, catupiri, milho e azeitonas)', NULL, 34.70, 4, 0, 0, 'n', 'A', 'y'),
	(121, 'P53', NULL, 4, 'SICILIANA (mussarela, palmito, champignon, pimentão, bacon e azeitonas)', NULL, 34.70, 4, 0, 0, 'n', 'A', 'y'),
	(122, 'P54', NULL, 4, 'FRANGOLINO (mussarela, frango, palmito, tomate, cebola e azeitonas)', NULL, 34.70, 4, 0, 0, 'n', 'A', 'y'),
	(123, 'P55', NULL, 4, 'FRANGO ESPECIAL (mussarela, frango refogado, bacon, cebola e azeitonas)', NULL, 34.70, 4, 0, 0, 'n', 'A', 'y'),
	(124, 'P56', NULL, 4, 'MARGUERITA ESPECIAL (mussarela, molho, tomate seco, gorgonzola, parmesão, manjericão e azeitonas)', NULL, 34.70, 4, 0, 0, 'n', 'A', 'y'),
	(125, 'P57', NULL, 4, 'CAMUSSA (catupiri, mussarela e azeitonas)', NULL, 34.70, 4, 0, 0, 'n', 'A', 'y'),
	(126, 'P58', NULL, 4, 'BROCOLIS ESPECIAL (brócolis, catupiri, alho, cebola, mussarela, tomate e azeitonas)', NULL, 34.70, 4, 0, 0, 'n', 'A', 'y'),
	(127, 'P59', NULL, 4, 'ATUM ESPECIAL (mussarela, atum, aliche, tomate, cebola e azeitonas)', NULL, 34.70, 4, 0, 0, 'n', 'A', 'y'),
	(128, 'P60', NULL, 4, 'PRESUNTO ESPECIAL (presunto, milho, catupiri, coberta com mussarela e azeitonas)', NULL, 34.70, 4, 0, 0, 'n', 'A', 'y'),
	(129, 'P61', NULL, 4, 'CHEFE (mussarela, presunto, champignon, cebola e azeitonas)', NULL, 34.70, 4, 0, 0, 'n', 'A', 'y'),
	(130, 'P62', NULL, 4, 'AMERICANA (calabresa, presunto, milho, palmito, ovos, cebola, mussarela e azeitonas)', NULL, 34.70, 4, 0, 0, 'n', 'A', 'y'),
	(131, 'P63', NULL, 4, 'BACALHAU (mussarela, bacalhau desfiado, ovos, tomate, cebola, rodelas de batata e azeitonas)', NULL, 34.70, 4, 0, 0, 'n', 'A', 'y'),
	(133, 'B01', NULL, 5, 'Coca cola 600ml', NULL, 5.00, 1, 2, 0, 'y', 'C', 'y');
/*!40000 ALTER TABLE `produto` ENABLE KEYS */;

-- Copiando estrutura para tabela mm_bd.produto_tamanho
...
-- Copiando dados para a tabela mm_bd.produto_tamanho: ~2 rows (aproximadamente)
...
-- Copiando dados para a tabela mm_bd.unidade: ~4 rows (aproximadamente)
...
-- Copiando dados para a tabela mm_bd.venda: ~14 rows (aproximadamente)
/*!40000 ALTER TABLE `venda` DISABLE KEYS */;
INSERT INTO `venda` (`id`, `cliente_id`, `desconto`, `total`, `data`, `status`, `comanda_mesa_id`, `caixa_id`) VALUES
	(216, NULL, 0.00, 34.70, '2017-12-01 18:45:13', 'A', NULL, 33),
	(217, NULL, 0.00, 104.10, '2017-12-01 19:19:17', 'A', NULL, 33),
	(218, NULL, 0.00, 69.40, '2017-12-01 19:27:23', 'A', 3, 33),
	(219, NULL, 0.00, 34.70, '2017-12-01 19:44:57', 'A', 3, 33),
	(220, NULL, 0.00, 69.40, '2017-12-01 19:45:15', 'A', NULL, 33),
	(221, NULL, 0.00, 69.40, '2017-12-01 23:44:14', 'A', NULL, 33),
	(222, NULL, 0.00, 39.85, '2017-12-01 23:55:59', 'A', NULL, 33),
	(223, NULL, 0.00, 39.85, '2017-12-02 00:03:03', 'A', NULL, 33),
	(224, NULL, 0.00, 34.70, '2017-12-02 16:26:21', 'A', NULL, 33),
	(225, NULL, 0.00, 34.70, '2017-12-02 16:29:34', 'A', NULL, 33),
	(226, NULL, 0.00, 45.00, '2017-12-02 16:32:24', 'A', NULL, 34),
	(227, NULL, 0.00, 114.40, '2017-12-02 18:25:39', 'A', NULL, 34),
	(228, NULL, 0.00, 159.40, '2017-12-02 18:27:47', 'A', NULL, 34),
	(229, NULL, 0.00, 34.70, '2017-12-02 18:46:39', 'A', NULL, 35);
...
-- Copiando dados para a tabela mm_bd.venda_pagto: ~15 rows (aproximadamente)
...
-- Copiando estrutura para tabela mm_bd._user_
...
-- Copiando dados para a tabela mm_bd._user_: ~0 rows (aproximadamente)
