...
-- Dumping data for table mm.caixa: ~3 rows (approximately)
...
-- Dumping data for table mm.categoria: ~4 rows (approximately)
...
-- Dumping data for table mm.comanda_mesa: ~4 rows (approximately)
...
-- Dumping structure for table mm.delivery
...
-- Dumping data for table mm.delivery: ~2 rows (approximately)
...
-- Dumping data for table mm.fisica: ~6 rows (approximately)
...
-- Dumping data for table mm.funcionario: ~0 rows (approximately)
...
-- Dumping data for table mm.help: ~2 rows (approximately)
...
-- Dumping data for table mm.help_item: ~6 rows (approximately)
...
-- Dumping data for table mm.itens_venda: ~24 rows (approximately)
...
-- Dumping data for table mm.module: ~16 rows (approximately)
...
-- Dumping data for table mm.modulo: ~4 rows (approximately)
...
-- Dumping data for table mm.pessoa: ~57 rows (approximately)
...
-- Dumping data for table mm.produto: ~65 rows (approximately)
...
-- Dumping structure for table mm.produto_tamanho
...
-- Dumping data for table mm.produto_tamanho: ~2 rows (approximately)
...
-- Dumping data for table mm.unidade: ~4 rows (approximately)
...
-- Dumping data for table mm.venda: ~14 rows (approximately)
...
-- Dumping data for table mm.venda_pagto: ~15 rows (approximately)
...
-- Dumping structure for procedure mm._Grid
DELIMITER //
...
-- Dumping structure for function mm._InsertUpdate
DELIMITER //
...
-- Dumping structure for function mm._lib_ColumnsSchema
DELIMITER //
...
-- Dumping structure for procedure mm._lib_ExecQuery
DELIMITER //
...
-- Dumping structure for function mm._lib_getColumnsToGrid
DELIMITER //
...
-- Dumping structure for function mm._lib_PriTable
DELIMITER //
...
-- Dumping structure for function mm._lib_SetByRequest
DELIMITER //
...
-- Dumping structure for table mm._myschema
...
-- Dumping data for table mm._myschema: ~0 rows (approximately)
