...
CREATE TABLE IF NOT EXISTS `delivery` (
  ...
  `status` enum('T','E','P') COLLATE latin1_general_ci NOT NULL DEFAULT 'T' COMMENT 'T = Transporte, E = Entregue, P = Pago',
  `detalhes` text COLLATE latin1_general_ci,
  `ent_1` int(11) NOT NULL,
...
-- Dumping data for table mm.entrada_produto: ~2 rows (approximately)
/*!40000 ALTER TABLE `entrada_produto` DISABLE KEYS */;
INSERT INTO `entrada_produto` (`id`, `tipo`, `produto_id`, `fornecedor_id`, `quantidade`, `lote`, `dt_compra`, `dt_validade`, `valor_unitario`, `valor_total`, `motivo_saida`, `dt_lancamento`) VALUES
	(1, 'E', 2, NULL, 20, NULL, NULL, NULL, NULL, NULL, NULL, '2017-10-27 13:16:28'),
	(2, 'E', 2, NULL, 50, NULL, NULL, NULL, NULL, NULL, NULL, '2017-11-23 09:22:44');
...
INSERT INTO `fisica` (`id`, `pessoa_id`, `nome`, `telefone`, `cpf`, `CEP`, `numero`, `endereco`, `complemento`, `observacao`, `rg`, `dt_nascimento`, `sexo`, `tem_conta`, `dia_mes_pagto`, `limite_conta`, `dt_cadastro`) VALUES
	...
	(10, 142, 'dgfd', '(11) 1111-1111', NULL, '022', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'y', NULL, NULL, '2017-11-28 09:33:11'),
...
-- Dumping data for table mm.fisica_conta: ~5 rows (approximately)
...
INSERT INTO `fisica_conta` (`id`, `fisica_id`, `tipo`, `valor`, `desconto`, `dt_cadastro`, `caixa_id`, `venda_id`) VALUES
	(1, 2, 'D', 10.00, NULL, '2017-11-28 08:18:51', 33, 112),
	(2, 9, 'D', 10.00, NULL, '2017-11-28 09:18:27', 33, 117),
	(3, 2, 'D', 10.00, NULL, '2017-11-29 07:54:55', 33, 118),
	(4, 2, 'D', 10.00, NULL, '2017-11-29 07:55:03', 33, 119),
	(5, 11, 'D', 10.00, NULL, '2017-11-29 09:29:55', 33, 122);
...
-- Dumping data for table mm.itens_venda: ~22 rows (approximately)
/*!40000 ALTER TABLE `itens_venda` DISABLE KEYS */;
INSERT INTO `itens_venda` (`id`, `venda_id`, `produto_id`, `quantidade`, `valor_unitario`, `status`, `nome_cliente`) VALUES
	(7, 106, 2, 1.00, 10.00, 'E', NULL),
	(8, 106, 2, 1.00, 10.00, 'E', NULL),
	(11, 108, 4, 1.00, 54.53, 'E', NULL),
	(13, 107, 3, 1.00, 23.23, 'E', NULL),
	(14, 109, 2, 2.00, 10.00, 'E', NULL),
	(16, 111, 2, 1.00, 10.00, 'C', NULL),
	(17, 110, 3, 1.00, 23.23, 'E', NULL),
	(18, 112, 2, 1.00, 10.00, 'C', NULL),
	(19, 113, 2, 1.00, 10.00, 'C', NULL),
	(23, 114, 3, 1.00, 23.23, 'E', NULL),
	(25, 116, 2, 1.00, 10.00, 'C', NULL),
	(26, 115, 2, 1.00, 10.00, 'E', NULL),
	(27, 117, 2, 1.00, 10.00, 'C', NULL),
	(28, 118, 2, 1.00, 10.00, 'C', NULL),
	(29, 119, 2, 1.00, 10.00, 'C', NULL),
	(30, 120, 2, 1.00, 10.00, 'C', NULL),
	(33, 121, 2, 1.00, 10.00, 'E', NULL),
	(34, 121, 3, 1.00, 23.23, 'E', NULL),
	(35, 122, 2, 1.00, 10.00, 'C', NULL),
	(175, 188, 5, 0.50, 35.00, 'C', NULL),
	(176, 188, 5, 0.50, 35.00, 'C', NULL),
	(177, 189, 2, 1.00, 10.00, 'C', NULL);
...
-- Dumping data for table mm.module: ~15 rows (approximately)
...
-- Dumping data for table mm.produto: ~4 rows (approximately)
...
INSERT INTO `produto` (`id`, `codigo`, `codbar`, `categoria_id`, `nome`, `descricao`, `valor`, `unidade_id`, `estoque_min`, `estoque`, `tem_estoque`, `active`) VALUES
	(2, '001', NULL, 2, 'Teste', NULL, 10.00, 1, 5, -158, 'n', 'y'),
	(3, '002', NULL, 2, 'Produto', NULL, 23.23, 1, 0, -119, 'n', 'y'),
	(4, '003', NULL, 2, 'Produto 3', NULL, 54.53, 1, 0, -50, 'n', 'y'),
	(5, 'P01', NULL, 4, 'Pizza Mussarela', NULL, 35.00, 4, 0, -2, 'n', 'y');
...
CREATE TABLE IF NOT EXISTS `venda` (
  ...
  `status` enum('A','F','C','E') DEFAULT NULL COMMENT 'A = Aberta F = Fechada C = Cancelada, E = Entrega',
...
-- Dumping data for table mm.venda: ~19 rows (approximately)
/*!40000 ALTER TABLE `venda` DISABLE KEYS */;
INSERT INTO `venda` (`id`, `cliente_id`, `desconto`, `total`, `data`, `status`, `comanda_mesa_id`, `caixa_id`, `delivery`, `entregador_id`) VALUES
	(106, NULL, 0.00, 20.00, '2017-11-27 21:51:34', 'A', 3, 33, 'N', NULL),
	(107, NULL, 0.00, 23.23, '2017-11-27 21:53:15', 'A', 3, 33, 'N', NULL),
	(108, NULL, 0.00, 54.53, '2017-11-27 21:53:23', 'A', 4, 33, 'N', NULL),
	(109, NULL, 0.00, 20.00, '2017-11-27 21:53:40', 'A', 4, 33, 'N', NULL),
	(110, NULL, 0.00, 23.23, '2017-11-27 21:54:27', 'A', 3, 33, 'N', NULL),
	(111, NULL, 0.00, 10.00, '2017-11-28 07:54:19', 'F', NULL, 33, 'N', NULL),
	(112, NULL, 0.00, 10.00, '2017-11-28 08:18:51', 'F', NULL, 33, 'N', NULL),
	(113, NULL, 0.00, 10.00, '2017-11-28 08:23:33', 'F', NULL, 33, 'N', NULL),
	(114, NULL, 0.00, 23.23, '2017-11-28 08:26:06', 'A', 3, 33, 'N', NULL),
	(115, NULL, 0.00, 10.00, '2017-11-28 08:30:50', 'A', 3, 33, 'N', NULL),
	(116, NULL, 0.00, 10.00, '2017-11-28 09:16:44', 'F', NULL, 33, 'N', NULL),
	(117, NULL, 0.00, 10.00, '2017-11-28 09:18:27', 'F', NULL, 33, 'N', NULL),
	(118, NULL, 0.00, 10.00, '2017-11-29 07:54:55', 'F', NULL, 33, 'N', NULL),
	(119, NULL, 0.00, 10.00, '2017-11-29 07:55:03', 'F', NULL, 33, 'N', NULL),
	(120, NULL, 0.00, 10.00, '2017-11-29 07:56:14', 'F', NULL, 33, 'N', NULL),
	(121, NULL, 0.00, 33.23, '2017-11-29 07:56:54', 'A', 4, 33, 'N', NULL),
	(122, NULL, 0.00, 10.00, '2017-11-29 09:29:55', 'F', NULL, 33, 'N', NULL),
	(188, NULL, 0.00, 35.00, '2017-11-29 18:53:25', 'F', NULL, 33, 'N', NULL),
	(189, NULL, 0.00, 10.00, '2017-11-29 22:29:04', 'F', NULL, 33, 'N', NULL);
...
-- Dumping data for table mm.venda_pagto: ~19 rows (approximately)
