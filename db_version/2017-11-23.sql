...
-- Dumping data for table mm.caixa: ~9 rows (approximately)
/*!40000 ALTER TABLE `caixa` DISABLE KEYS */;
INSERT INTO `caixa` (`id`, `valor_inicial`, `valor_fechamento`, `funcionario_id`, `dt_abertura`, `dt_fechamento`) VALUES
	(21, 50.00, NULL, 1, '2017-10-25 17:37:33', '2017-11-06 08:37:24'),
	(25, 25.40, 5.84, 1, '2017-11-06 08:39:07', '2017-11-06 08:41:15'),
	(26, 6.54, 5.84, 1, '2017-11-06 08:41:49', '2017-11-06 08:42:11'),
	(27, 2.54, 0.25, 1, '2017-11-06 08:42:22', '2017-11-06 08:42:30'),
	(28, 5.84, 0.00, 1, '2017-11-06 08:42:42', '2017-11-06 08:42:46'),
	(29, 5.84, 0.00, 1, '2017-11-06 08:43:50', '2017-11-22 08:46:23'),
	(30, 52.00, NULL, 1, '2017-11-22 08:49:26', '2017-11-22 09:25:40'),
	(31, 0.00, 0.00, 1, '2017-11-22 09:50:58', '2017-11-22 09:51:01'),
	(32, 0.00, 0.00, 1, '2017-11-22 13:36:53', NULL);
...
-- Dumping data for table mm.comanda_mesa: ~2 rows (approximately)
/*!40000 ALTER TABLE `comanda_mesa` DISABLE KEYS */;
INSERT INTO `comanda_mesa` (`id`, `codigo`, `active`, `status`, `dt_status_O`, `dt_status_L`) VALUES
	(1, '01', 'y', 'O', '2017-11-23 09:26:56', NULL),
	(2, '02', 'y', 'O', '2017-11-23 09:25:50', NULL);
...
-- Dumping data for table mm.entrada_produto: ~1 rows (approximately)
...
-- Dumping data for table mm.fisica: ~1 rows (approximately)
...
INSERT INTO `fisica` (`id`, `pessoa_id`, `cpf`, `nome`, `rg`, `dt_nascimento`, `sexo`, `tem_conta`, `dia_mes_pagto`, `limite_conta`) VALUES
	(1, 133, '301.625.408-50', 'Ulisses Bueno da Silva', NULL, NULL, NULL, 'y', NULL, 20.00);
...
-- Dumping data for table mm.fisica_conta: ~2 rows (approximately)
...
INSERT INTO `fisica_conta` (`id`, `fisica_id`, `tipo`, `valor`, `desconto`, `dt_cadastro`, `caixa_id`, `venda_id`) VALUES
	(1, 1, 'D', 10.00, NULL, '2017-11-01 07:58:24', 21, 2),
	(2, 1, 'C', 5.00, 0, '2017-11-01 07:58:35', 21, NULL);
...
INSERT INTO `funcionario` (`id`, `nome`, `tipo_us`, `pessoa_id`, `login`, `senha`, `token_change_password`) VALUES
	(1, 'Administrador', 'M', 1, 'adm', '4297f44b13955235245b2497399d7a93', '');
...
-- Dumping data for table mm.help: ~3 rows (approximately)
...
-- Dumping data for table mm.itens_venda: ~5 rows (approximately)
/*!40000 ALTER TABLE `itens_venda` DISABLE KEYS */;
INSERT INTO `itens_venda` (`id`, `venda_id`, `produto_id`, `quantidade`, `valor_unitario`, `status`, `nome_cliente`) VALUES
	(1, 1, 2, 6.00, 60.00, 'E', NULL),
	(2, 2, 2, 1.00, 10.00, 'E', NULL),
	(3, 3, 2, 1.00, 10.00, 'E', NULL),
	(4, 4, 2, 1.00, 10.00, 'E', NULL),
	(5, 5, 2, 5.00, 50.00, 'E', NULL),
	(6, 6, 2, 1.00, 10.00, 'C', NULL),
	(7, 7, 2, 1.00, 10.00, 'C', NULL),
	(8, 8, 2, 1.00, 10.00, 'C', NULL),
	(9, 9, 2, 1.00, 10.00, 'C', NULL),
	(10, 10, 2, 1.00, 10.00, 'C', NULL),
	(11, 11, 2, 1.00, 10.00, 'C', NULL),
	(12, 12, 2, 1.00, 10.00, 'C', NULL),
	(13, 13, 2, 1.00, 10.00, 'C', NULL),
	(14, 14, 2, 1.00, 10.00, 'C', NULL),
	(15, 15, 2, 1.00, 10.00, 'C', NULL),
	(16, 16, 2, 1.00, 10.00, 'C', NULL),
	(17, 17, 2, 1.00, 10.00, 'C', NULL);
...
-- Dumping data for table mm.module: ~13 rows (approximately)
/*!40000 ALTER TABLE `module` DISABLE KEYS */;
INSERT INTO `module` (`module_id`, `text`, `parent`, `active`, `link`, `order`, `icon`) VALUES
	(1, 'Cadastro', NULL, 'Y', '', 1, NULL),
	(2, 'Categoria', 1, 'Y', 'internals/category', 1.1, NULL),
	(6, 'Produtos', NULL, 'Y', 'internals/product', 0.1, 'fa-futbol-o'),
	(13, 'Fornecedores', 1, 'Y', 'internals/company', 1.3, NULL),
	(14, 'Funcionários', 1, 'Y', 'internals/employee', 1.4, NULL),
	(15, 'Clientes', 1, 'Y', 'internals/buyer', 1.5, NULL),
	(16, 'Unidades', 1, 'Y', 'internals/measure', 1.6, NULL),
	(17, 'Formas de Pagamento', 1, 'Y', 'internals/payment', 1.7, NULL),
	(18, 'Controle de Estoque', NULL, 'Y', 'internals/stock', 0.2, NULL),
	(19, 'Relatórios', NULL, 'Y', NULL, 2, NULL),
	(20, 'Vendas', 19, 'Y', NULL, 2.1, NULL),
	(21, 'Perfil', NULL, 'Y', NULL, 3, NULL),
	(22, 'Mesas', 1, 'Y', 'grid/tables', 1.8, NULL);
...
-- Dumping data for table mm.modulo: ~5 rows (approximately)
...
-- Dumping data for table mm.pessoa: ~39 rows (approximately)
...
INSERT INTO `produto` (`id`, `codigo`, `codbar`, `categoria_id`, `nome`, `descricao`, `valor`, `unidade_id`, `estoque_min`, `estoque`, `tem_estoque`, `active`) VALUES
	(2, '001', NULL, 2, 'Teste', NULL, 10.00, 1, 5, 44, 'y', 'y');
...
-- Dumping data for table mm.venda: ~4 rows (approximately)
/*!40000 ALTER TABLE `venda` DISABLE KEYS */;
INSERT INTO `venda` (`id`, `cliente_id`, `desconto`, `total`, `data`, `status`, `comanda_mesa_id`, `caixa_id`) VALUES
	(1, NULL, 0.00, 60.00, '2017-10-31 11:32:40', 'F', 1, 21),
	(2, NULL, 0.00, 10.00, '2017-11-01 07:58:24', 'F', 1, 21),
	(3, NULL, 0.00, 10.00, '2017-11-06 08:42:07', 'F', 1, 26),
	(4, NULL, 0.00, 10.00, '2017-11-06 08:42:26', 'F', 1, 27),
	(5, NULL, 0.00, 50.00, '2017-11-06 08:44:09', 'F', 1, 29),
	(6, NULL, 0.00, 10.00, '2017-11-23 09:04:14', 'F', 1, 32),
	(7, NULL, 0.00, 10.00, '2017-11-23 09:06:39', 'F', 1, 32),
	(8, NULL, 0.00, 10.00, '2017-11-23 09:06:53', 'F', 2, 32),
	(9, NULL, 0.00, 10.00, '2017-11-23 09:08:04', 'F', 1, 32),
	(10, NULL, 0.00, 10.00, '2017-11-23 09:09:14', 'F', 2, 32),
	(11, NULL, 0.00, 10.00, '2017-11-23 09:09:35', 'F', 2, 32),
	(12, NULL, 0.00, 10.00, '2017-11-23 09:22:51', 'F', 2, 32),
	(13, NULL, 0.00, 10.00, '2017-11-23 09:24:05', 'F', 2, 32),
	(14, NULL, 0.00, 10.00, '2017-11-23 09:25:50', 'F', 2, 32),
	(15, NULL, 0.00, 10.00, '2017-11-23 09:26:36', 'F', 2, 32),
	(16, NULL, 0.00, 10.00, '2017-11-23 09:26:45', 'F', 2, 32),
	(17, NULL, 0.00, 10.00, '2017-11-23 09:26:56', 'F', 1, 32);
...
-- Dumping data for table mm.venda_pagto: ~5 rows (approximately)
