...
-- Dumping data for table mm.categoria: ~0 rows (approximately)
...
-- Dumping data for table mm.module: ~6 rows (approximately)
...
INSERT INTO `module` (`module_id`, `text`, `parent`, `active`, `link`, `order`) VALUES
	...
	(13, 'Fornecedores', 1, 'Y', 'internals/', 1.3),
	(14, 'Funcionários', 1, 'Y', 'internals/', 1.4),
...
-- Dumping data for table mm.pessoa: ~0 rows (approximately)
