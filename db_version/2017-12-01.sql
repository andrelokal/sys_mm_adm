...
INSERT INTO `caixa` (`id`, `valor_inicial`, `valor_fechamento`, `funcionario_id`, `dt_abertura`, `dt_fechamento`) VALUES
	(33, 0.00, 0.00, 1, '2017-11-23 21:02:43', NULL);
...
-- Dumping data for table mm.categoria: ~3 rows (approximately)
...
INSERT INTO `comanda_mesa` (`id`, `codigo`, `active`, `status`, `dt_status_O`, `dt_status_L`, `venda_id`) VALUES
	(3, '01', 'y', 'L', '2017-11-28 09:16:54', NULL, NULL),
...
INSERT INTO `config` (`id`, `nome_empresa`, `desc_cupom`, `print_port`, `valor_entregador_delivery`, `pizza_tamanho_min`) VALUES
	(1, 'JJ - armarinho', NULL, NULL, NULL, 0.50);
...
-- Dumping data for table mm.delivery: ~0 rows (approximately)
...
-- Dumping data for table mm.fisica: ~5 rows (approximately)
...
-- Dumping data for table mm.fisica_conta: ~4 rows (approximately)
...
-- Dumping data for table mm.pessoa: ~56 rows (approximately)
...
-- Dumping data for table mm.produto: ~63 rows (approximately)
...
INSERT INTO `produto` (`id`, `codigo`, `codbar`, `categoria_id`, `nome`, `descricao`, `valor`, `unidade_id`, `estoque_min`, `estoque`, `tem_estoque`, `status_inicial`, `active`) VALUES
	(69, 'P01', NULL, 4, 'MUSSARELA (mussarela, tomate e azeitonas)', NULL, 34.70, 4, 0, -9, 'n', 'A', 'y'),
	(70, 'P02', NULL, 4, 'CATUPIRI (catupiri, tomate e azeitonas)', NULL, 34.70, 4, 0, -3, 'n', 'A', 'y'),
	(71, 'P03', NULL, 4, 'MARGUERITA (mussarela, tomate, manjeric?o, parmes?o e azeitonas)', NULL, 34.70, 4, 0, -3, 'n', 'A', 'y'),
	(72, 'P04', NULL, 4, 'PROMUSSA (provolone, mussarela e azeitonas)', NULL, 34.70, 4, 0, -1, 'n', 'A', 'y'),
	(73, 'P05', NULL, 4, 'TR?S QUEIJOS (mussarela, provolone, catupiri e azeitonas)', NULL, 34.70, 4, 0, -2, 'n', 'A', 'y'),
	(74, 'P06', NULL, 4, 'QUATRO QUEIJOS (mussarela, provolone, catupiri, gorgonzola e azeitonas)', NULL, 34.70, 4, 0, 0, 'n', 'A', 'y'),
...
-- Dumping data for table mm.venda: ~6 rows (approximately)
...
INSERT INTO `_user_` (`id`, `email`, `password`, `token_change_password`, `dt_register`, `dt_update`) VALUES
	(3, 'ulisses.bueno@gmail.com', '4297f44b13955235245b2497399d7a93', '955a49810b7685fdaeea6f008c33fcf7', '2017-06-09 21:29:18', '2017-10-27 13:00:11');
