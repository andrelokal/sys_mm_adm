...
-- Copiando dados para a tabela mm.itens_venda: ~30 rows (aproximadamente)
...
-- Copiando dados para a tabela mm.venda: ~21 rows (aproximadamente)
...
-- Copiando dados para a tabela mm.venda_pagto: ~20 rows (aproximadamente)
